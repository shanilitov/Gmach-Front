...
export default function NewDeposit() {
  ...
  const [cardId, setCardId] = React.useState("");// A cardId of card from the DB
  const [cardIdFromDB, setCardIdFromDB] = React.useState(false);// If there is a card in the DB
